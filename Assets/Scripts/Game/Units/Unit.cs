...
public class Unit : MonoBehaviour {
	...
	/** Stats **/
	//Stamina
	protected int Max_Stam = 100;
	private int current_hp;
	public int Current_Stam {get{return current_hp;} set{current_hp = value; if (value <= 0){ Destroy_Unit();}}}
	...
	public void Play_Animation(string animation_to_play){
